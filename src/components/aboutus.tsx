      ...
      <div className="w-full flex flex-col items-center mx-auto gap-8 max-w-4xl">
        ...
        <div className="text-center lg:text-left max-w-3xl">
          ...
          <ul className="text-sm text-[#444444] mb-8 space-y-2 leading-relaxed">
            <li>
              <strong>George</strong> is a machine learning and data scientist, formerly at Anglo American.
            </li>
            <li>
              <strong>Will</strong> is a postdoctoral researcher focused on water, climate, and disaster risk (he never left Imperial).
            </li>
            <li>
              <strong>Jack</strong> builds commercial teams in early-stage startups and is an ex-founder.
            </li>
          </ul>
