          ...
          return (
            ...
            >
              <div className="md:flex md:gap-8">
                ...
                <div className={`md:w-1/2 py-2 transition-colors duration-300 md:text-right ${isActive ? 'text-gray-900' : 'text-gray-500'}`}>
                  <h3 className="font-medium text-lg md:text-xl transition-colors duration-500">
                    {step.title}
                  </h3>
                </div>
                  ...
                  <div className="hidden md:block md:h-24">
                    <AnimatePresence mode="wait">
                      {isActive && (
                        ...
                        >
                          <p className="text-sm text-gray-800 pr-4 whitespace-pre-line">{step.desc}</p>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </div>
                    ...
                    <div className="absolute top-0 left-0 right-0">
                      <AnimatePresence>
                        {isActive && (
                          ...
                          >
                            <p className="text-sm text-gray-800 whitespace-pre-line">{step.desc}</p>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </div>
