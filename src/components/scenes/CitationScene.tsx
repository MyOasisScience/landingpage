    ...
    <Scene scrollProgress={scrollProgress}>
      <div className="w-full max-w-4xl">
        <div className="text-gray-900">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-3 sm:mb-4 text-center">Track citation milestones in real-time</h2>
          <p className="text-base sm:text-lg text-gray-800 mb-6 sm:mb-8 text-center">We notify you when relevant research hits key citation or impact thresholds.</p>
          ...
          <div className="space-y-4 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-6">
              {/* Self-Injury Study */}
              <motion.div
                className="bg-gradient-to-br from-white to-gray-100 p-3 sm:p-6 rounded-lg border border-gray-200 shadow-md hover:scale-[1.02] transition-transform"
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="font-semibold text-sm sm:text-xl text-gray-800 mb-1 sm:mb-2 leading-tight">
                      &ldquo;Self-Injury in College Youth&rdquo;
                    </h3>
                    <p className="text-xs sm:text-lg text-gray-800">Whitlock et al. • Pediatrics • 2006</p>
                    <p className="text-xs sm:text-sm text-gray-700 mt-1 sm:mt-2 italic">
                      Crossed 1,000 citations — now a clinical and policy reference point.
                    </p>
                  </div>
                  <div className="text-right ml-2 sm:ml-4 flex-shrink-0">
                    <div className="text-lg sm:text-2xl font-bold text-blue-600">1,524</div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-lg text-gray-800">Nature • 2004</p>
                    <p className="text-xs sm:text-sm text-gray-700 mt-1 sm:mt-2 italic">
                      Surpassed 1,000 citations — now a core method in compact particle physics.
                    </p>
                  </div>
                  <div className="text-right ml-2 sm:ml-4 flex-shrink-0">
                    <div className="text-lg sm:text-2xl font-bold text-green-600">2,699</div>
                    <div className="text-xs sm:text-sm text-gray-500">citations</div>
                  </div>
                </div>
              </motion.div>
