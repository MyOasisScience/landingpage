    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="w-full">
          <TextReveal 
            className="font-sans text-2xl md:text-4xl justify-center font-medium tracking-tight text-neutral-900 max-w-2xl md:max-w-3xl leading-tight mx-auto text-center"
          >
            {textContent}
          </TextReveal>
        </div>
